...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO `categories` (`category_id`, `category_name`, `category_description`, `timestamp`, `category_image`) 
    VALUES (NULL, '$catname', '$catdesc', current_timestamp(), '$catimage');";
