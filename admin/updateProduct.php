  ...
  <div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
      <div class="form-group">
        ...
        <input type="file" name="product_image" class="form-control" value="<?php echo $product_name ?>" required>
      </div>
      <div class=" form-group">
      ...
      <div class=" form-group">
        ...
        <select class="form-control" id="category" name="category" value="<?php echo $product_category ?>" required>
          <?php
