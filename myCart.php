          ...
          while ($row = mysqli_fetch_assoc($result1)) {
            ...
            echo '<tbody>
                        <tr>
                            ...
                            <td class="text-center"><img src="img/' . $product_image . '" alt="" class="prod_img"></td>
                            <td class="text-center">Rs.' . $product_price . '</td>
                            <td class="text-center"><form action="handleCart.php?cartid=' . $cartProductid . '" method="post">
                                <input class="widthy" type="number" value="' . $product_quantity . '" max="10" name="quantity">
                                <button class="btn btn-danger" type="submit">Update quantity</button>
                                </form></td>
                            <td class="text-center"><a class="btn btn-success text-center" href="product.php?productid=' . $productid . '&request=view">View</a>
          ...
          while ($row = mysqli_fetch_assoc($result1)) {
            ...
            echo '<tbody>
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-success text-center" href="product.php?productid=' . $productid . '&request=view">View</a>
                            <a class="btn btn-warning text-center" href="handleCart.php?productid=' . $productid . '&request=delete">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                   ';
